        ...
        data.length > 0 ?
          <>
            <section className="w-[80%] flex flex-col items-center animate-ease-in">
              ...
              <footer className="mt-12 flex justify-between w-[50%]">
                  <img src={visa} className="w-12 h-12 hover:scale-105 opacity-60" />
                  <img src={mastercard} className="w-12 h-12 hover:scale-105 opacity-60" />
                  <img src={jcb} className="w-12 h-12 hover:scale-105 opacity-60" />
                  <img src={american} className="w-12 hover:scale-105 h-12 opacity-60" />
                  <img src={diner} className="w-12 h-12 hover:scale-105 opacity-60" />
              </footer>
            </section>
